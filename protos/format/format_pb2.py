...
_AVRO_PARSER.fields_by_name['schema'].message_type = protos_dot_schema_dot_schema__pb2._MAP
...
_JSON_PARSER.fields_by_name['schema'].message_type = protos_dot_schema_dot_schema__pb2._MAP
_JSON_PARSER.containing_type = _JSON
_PARQUET_FORMATTER.containing_type = _PARQUET
_PARQUET_PARSER.fields_by_name['schema'].message_type = protos_dot_schema_dot_schema__pb2._MAP
...
_LAMBDA_PARSER.fields_by_name['schema'].message_type = protos_dot_schema_dot_schema__pb2._MAP
...
_XSV_OPTIONS.fields_by_name['line_ending'].message_type = protos_dot_text_dot_text__pb2._LINEENDING
_XSV_OPTIONS.containing_type = _XSV
_XSV_FORMATTER.fields_by_name['line_ending'].message_type = protos_dot_text_dot_text__pb2._LINEENDING
...
_XSV_PARSER.fields_by_name['schema'].message_type = protos_dot_schema_dot_schema__pb2._MAP
...
_COLUMNS_PARSINGSPECIFICATION.fields_by_name['boolean'].message_type = protos_dot_schema_dot_schema__pb2._BOOLEAN_PARSER
_COLUMNS_PARSINGSPECIFICATION.fields_by_name['date'].message_type = protos_dot_schema_dot_schema__pb2._DATE_PARSER
_COLUMNS_PARSINGSPECIFICATION.fields_by_name['double'].message_type = protos_dot_schema_dot_schema__pb2._DOUBLE_PARSER
_COLUMNS_PARSINGSPECIFICATION.fields_by_name['float'].message_type = protos_dot_schema_dot_schema__pb2._FLOAT_PARSER
_COLUMNS_PARSINGSPECIFICATION.fields_by_name['int'].message_type = protos_dot_schema_dot_schema__pb2._INT_PARSER
_COLUMNS_PARSINGSPECIFICATION.fields_by_name['long'].message_type = protos_dot_schema_dot_schema__pb2._LONG_PARSER
_COLUMNS_PARSINGSPECIFICATION.fields_by_name['string'].message_type = protos_dot_schema_dot_schema__pb2._STRING_PARSER
_COLUMNS_PARSINGSPECIFICATION.fields_by_name['timestamp'].message_type = protos_dot_schema_dot_schema__pb2._TIMESTAMP_PARSER
...
Avro = _reflection.GeneratedProtocolMessageType('Avro', (_message.Message,), dict(
  ...
  Formatter = _reflection.GeneratedProtocolMessageType('Formatter', (_message.Message,), dict(
    ...
    __module__ = 'protos.format.format_pb2'
