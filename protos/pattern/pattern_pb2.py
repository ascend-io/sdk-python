...
# source: protos/pattern/pattern.proto
...
Pattern = _reflection.GeneratedProtocolMessageType('Pattern', (_message.Message,), dict(
  DESCRIPTOR = _PATTERN,
  __module__ = 'protos.pattern.pattern_pb2'
