...
_READCONNECTOR_FROMBYTES.fields_by_name['parser'].message_type = ascend_dot_protos_dot_operator_dot_operator__pb2._OPERATOR
_READCONNECTOR_FROMBYTES.containing_type = _READCONNECTOR
_READCONNECTOR_FROMRECORDS.fields_by_name['schema'].message_type = ascend_dot_protos_dot_schema_dot_schema__pb2._MAP
...
_WRITECONNECTOR_TOBYTES.fields_by_name['formatter'].message_type = ascend_dot_protos_dot_operator_dot_operator__pb2._OPERATOR
_WRITECONNECTOR_TOBYTES.fields_by_name['content_encoding'].message_type = ascend_dot_protos_dot_content__encoding_dot_content__encoding__pb2._CONTENTENCODING
