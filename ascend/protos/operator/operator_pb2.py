...
# source: protos/operator/operator.proto
...
_OPERATOR = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='parquet_formatter', full_name='operator.Operator.parquet_formatter', index=7,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='parquet_parser', full_name='operator.Operator.parquet_parser', index=8,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='xsv_formatter', full_name='operator.Operator.xsv_formatter', index=9,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='xsv_parser', full_name='operator.Operator.xsv_parser', index=10,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='spark_function', full_name='operator.Operator.spark_function', index=11,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='sql_query', full_name='operator.Operator.sql_query', index=12,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_SPARK_FUNCTION.fields_by_name['executable'].message_type = protos_dot_function_dot_function__pb2._EXECUTABLE
_SPARK_FUNCTION.fields_by_name['reduction'].message_type = _REDUCTION
_SPARK_FUNCTION.fields_by_name['credentials_configuration'].message_type = protos_dot_io_dot_io__pb2._FUNCTION_CREDENTIALSCONFIGURATION
...
_IDENTITY.fields_by_name['schema'].message_type = protos_dot_schema_dot_schema__pb2._SCHEMA
_OPERATOR.fields_by_name['avro_formatter'].message_type = protos_dot_format_dot_format__pb2._AVRO_FORMATTER
_OPERATOR.fields_by_name['avro_parser'].message_type = protos_dot_format_dot_format__pb2._AVRO_PARSER
_OPERATOR.fields_by_name['grok_parser'].message_type = protos_dot_format_dot_format__pb2._GROK_PARSER
_OPERATOR.fields_by_name['json_formatter'].message_type = protos_dot_format_dot_format__pb2._JSON_FORMATTER
_OPERATOR.fields_by_name['json_parser'].message_type = protos_dot_format_dot_format__pb2._JSON_PARSER
_OPERATOR.fields_by_name['lambda_formatter'].message_type = protos_dot_format_dot_format__pb2._LAMBDA_FORMATTER
_OPERATOR.fields_by_name['lambda_parser'].message_type = protos_dot_format_dot_format__pb2._LAMBDA_PARSER
_OPERATOR.fields_by_name['parquet_formatter'].message_type = protos_dot_format_dot_format__pb2._PARQUET_FORMATTER
_OPERATOR.fields_by_name['parquet_parser'].message_type = protos_dot_format_dot_format__pb2._PARQUET_PARSER
_OPERATOR.fields_by_name['xsv_formatter'].message_type = protos_dot_format_dot_format__pb2._XSV_FORMATTER
_OPERATOR.fields_by_name['xsv_parser'].message_type = protos_dot_format_dot_format__pb2._XSV_PARSER
...
Granularity = _reflection.GeneratedProtocolMessageType('Granularity', (_message.Message,), dict(
  ...
  Time = _reflection.GeneratedProtocolMessageType('Time', (_message.Message,), dict(
    ...
    Auto = _reflection.GeneratedProtocolMessageType('Auto', (_message.Message,), dict(
      ...
      __module__ = 'protos.operator.operator_pb2'
